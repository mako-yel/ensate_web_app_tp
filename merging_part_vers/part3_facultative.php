...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_offer'])) {
        if (!empty($_POST['company_email']) && !empty($_POST['title']) && !empty($_POST['description'])) {
            try {
                        ...
                        <form method="POST">
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <select name="company_email" required>
                                        <option value="">Sélectionner une entreprise</option>
                                        <?php foreach ($companies as $company): ?>
                                            <option value="<?= $company['email'] ?>"><?= htmlspecialchars($company['name']) ?> (<?= htmlspecialchars($company['city']) ?>)</option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
