...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_offer'])) {
    ...
    if (!empty($title) && !empty($description)) {
        if ($db->addInternshipOffer($company_id, $title, $description, $requirements, $duration, $location, $deadline)) {
...
// Get company data
$offers = $db->getCompanyOffers($company_id);
$applications = $db->getCompanyApplications($company_id);
?>
